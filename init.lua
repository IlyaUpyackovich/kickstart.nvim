...
require('lazy').setup({
  ...
  'editorconfig/editorconfig-vim', -- EditorConfig support for consistent coding styles
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'templ', 'slim' },
